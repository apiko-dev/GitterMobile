...
import s from '../styles/screens/RoomSettings'
...
import Section from '../components/RoomSettings/Section'
...
class RoomSettings extends Component {
  ...
  componentWillMount() {
    ...
    this.setState({
      pickerState: settings.mode === 'all' ? 0 : settings.mode === 'announcement' ? 1 : 2
    })
  }
